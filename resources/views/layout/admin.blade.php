    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="{{url ('admin\store\list')}}"><i class="menu-icon fa fa-home"></i>Magasin</a>
                    <a href="{{url ('admin\user\list')}}"><i class="menu-icon fa fa-user"></i>Utilisateur</a>
                    <a href="{{url ('admin\city\list')}}"><i class="menu-icon fa fa-map-marker"></i>Ville</a>
                    <a href="{{url ('admin\category\list')}}"><i class="menu-icon fa fa-tag"></i>Catégorie</a>
                    <a href="{{url ('admin\subcategory\list')}}"><i class="menu-icon fa fa-tags"></i>Sous Catégorie</a>
                    <a href="{{url ('admin\promotion\list')}}"><i class="menu-icon fa fa-cart-plus"></i>Promotion</a>
