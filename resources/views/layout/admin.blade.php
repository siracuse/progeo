        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <a href="{{url ('admin\city\list')}}"><i class="menu-icon fa fa-laptop"></i>Ville</a>
                    <a href="{{url ('admin\category\list')}}"><i class="menu-icon fa fa-laptop"></i>Catégorie</a>
                    <a href="{{url ('admin\subcategory\list')}}"><i class="menu-icon fa fa-laptop"></i>Sous Catégorie</a>
                    <a href="{{url ('admin\promotion\list')}}"><i class="menu-icon fa fa-laptop"></i>Promotion</a>
